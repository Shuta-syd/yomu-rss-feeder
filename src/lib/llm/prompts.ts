...
- translation: 原文が日本語の場合はnullを返す。英語など他言語の場合は全文を自然な日本語に翻訳する。
  * 入力されたHTML構造(タグ、属性、画像、リンク)を完全に保持し、テキストノードのみ翻訳すること
  * <img>, <a href=...>, <figure>, <h1>-<h6>, <p>, <ul>, <ol>, <li>, <blockquote>, <pre>, <code>, <strong>, <em> などのタグは原文のまま保持
  * 画像URL、リンクURL、alt属性等は一切変更しない
  * HTMLとして有効な形式で返す (閉じタグを忘れない、エスケープが必要な文字は&amp;等)
...
出力フォーマット:
{
  ...
  "translation": "<p>日本語翻訳のHTML</p> (原文が日本語なら null)",
